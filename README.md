...
`select for previous prime` : `curl 'http://GKECLUSTERSERVICE:8000/api/prime_prev/12/?format=json`
`select for All`            : `curl 'http://GKECLUSTERSERVICE:8000/api/all/12/?format=json`
